              ...
              <>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="bg-cell-blue">B2G</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <th scope="row">
                            <span className="text-req">주차장종류</span>
                          </th>
                          <td>
                            <SelectBasic size="m" />
                          </td>
                        ...
                        <tr>
                          <th scope="row">
                            <span className="text-req">운영기간</span>
                          </th>
                          <td colSpan={3}>
                            <div className="flex items-center gap-3">
                              <FormDateRange />
                        ...
                        <tr>
                          <th scope="row">
                            <span className="text-req">서비스시작일</span>
                          </th>
                          <td>
                            <FormDate selected={new Date()} />
                          </td>
                          <th scope="row">서비스만료일</th>
                          <td>
                        ...
                        <tr>
                          <th scope="row" className="bg-h-red">
                            구간번호
                          </th>
                          <td>
                            <Input placeholder="구간번호를 입력하세요." />
                          </td>
                          <th scope="row">배정자 수</th>
                          <td>
                            <button type="button">
                              <span className="underline">00</span> 명
                            </button>
                          </td>
                        </tr>
                        <tr>
                          <th scope="row">
                            <span className="text-req">주차면수</span>
                          </th>
                          <td colSpan={3}>
                            <div className="flex items-center gap-3">
                        ...
                        <tr>
                          <th scope="row">서울시 인프라 아이디</th>
                          <td>
                            <Input size="m" />
                          </td>
                          <th scope="row">주차권 판매여부</th>
                          <td>
                            <div className="flex items-center gap-3">
                ...
                <Accordion title="주차장 이미지*" open>
                  <>
                    ...
                    <ul className="px-4 py-[0.8125rem] mt-3 text-muted text-sm">
                      <li>
                        ※이미지는 최대 5개까지 등록할 수 있습니다. 이미지를 직접
                        드래그 하시거나 클릭시 파일을 등록할 수 있습니다.
                      </li>
                      <li>※이미지를 선택하시면 확대화면을 볼 수 있습니다.</li>
                      <li>
                    ...
                    <div className="table-basic">
                      <table>
                        ...
                        <tbody>
                          <tr>
                            <th scope="row">
                              <span className="text-req">요금정보</span>
                            </th>
                            <td>
                              <div className="grid grid-cols-[8.75rem_1fr] gap-[0.8125rem]">
                                <Checkbox label="초기무료기준" defaultChecked />
                                <Input placeholder="30분 무료" size="m" />
                                <Checkbox label="기본요금" defaultChecked />
                                <Input placeholder="10분 1000원" size="m" />
                                <Checkbox label="추가요금" defaultChecked />
                                <Input placeholder="10분 50원" size="m" />
                                <Checkbox label="당일최대" />
                                <Input size="m" disabled />
                                <Checkbox label="할증기준시간" />
                                <FormTimeRange />
                                <Checkbox label="할증요금" />
                                <Input size="m" disabled />
                              </div>
                          ...
                          <tr>
                            <th scope="row">
                              <span className="text-req">운영시간</span>
                            </th>
                            <td>
                ...
                >
                  <div className="flex items-center -mx-2 divide-x divide-[#8A99AF] py-[0.8125rem] bg-cell-purple">
                    ...
                    <div className="flex items-center gap-3 px-6">
                      <Checkbox label="실외" />
                      <Checkbox label="전기차 고속충전기" />
                      <Checkbox label="화장실" />
                      <Checkbox label="세차" />
                      <Checkbox label="발렛" />
                    </div>
                    <div className="flex items-center gap-3 px-6">
                      <Checkbox label="전기차 충전불가" />
                    </div>
                  </div>
                </Accordion>
                ...
                <Accordion title="유의사항" open>
                  <div className="px-4 py-[0.8125rem] bg-cell-purple">
                    ...
                    <ul className="mt-[0.8125rem] text-muted text-sm">
                      <li>※주차장상세에 노출되는 유의사항을 등록합니다.</li>
                      <li>
                        ※&#91;유의사항 불러오기&#93; 버튼을 선택 하시면 등록되어
                        있는 템플릿으로 수정할 수 있습니다.
                      </li>
                    </ul>
                  </div>
                      ...
                      <table>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th scope="col">판매변경예약</th>
                            <th scope="col">결제방식</th>
                            <th scope="col">등록자</th>
                            <th scope="col">등록일시</th>
                            <th scope="col">최종수정자</th>
                            <th scope="col">최초수정일시</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                ...
                <Accordion title="시설정보" open>
                  <div className="pt-4 pb-8">
                    <div className="flex items-center min-h-[2.5rem]">
                      ...
                      <Button type="gray" size="m" className="ml-4 mr-auto">
                        선택삭제
                      </Button>
                      <Button type="black" size="m">
                        등록
                      ...
                      <table>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th scope="col">상태</th>
                            <th scope="col">최초설치자</th>
                            <th scope="col">최초설치일시</th>
                            <th scope="col">최초수정자</th>
                            <th scope="col">최초수정일시</th>
                          </tr>
                        </thead>
                        <tbody>
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>-</td>
                          <td>
                            <p className="text-right">100,000원</p>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <th scope="row">총합계</th>
                          <td colSpan={10}>
                            <p className="font-bold text-right">1,000,000원</p>
                          </td>
                        </tr>
                        <tr>
