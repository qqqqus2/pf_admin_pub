            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div className="flex items-center gap-7">
                      <Radio name="t1" label="사용" defaultChecked />
                ...
                <tr>
                  ...
                  <td colSpan={5}>
                    <div className="flex items-center gap-7">
                      <Radio name="t2" label="일반쿠폰" defaultChecked />
                      <Radio name="t2" label="오프라인쿠폰" />
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colSpan={5}>
                    <div className="flex items-center gap-7">
                      <Radio name="t3" label="정액" defaultChecked />
                ...
                <tr>
                  ...
                  <td colSpan={5}>
                    ...
                    <p className="text-muted text-sm mt-3">
                      설정된 기간동안 다운로드가 가능한 쿠폰이 노출됩니다.
                      무제한 선택 시 발급시작일은 익일부터로 설정됩니다.
                    </p>
                  </td>
                </tr>
                <tr>
                  <th scope="row">
                    <span className="text-req">발급기간</span>
                  </th>
                  <td colSpan={5}>
                    <div className="flex items-center gap-7">
                      <Radio name="t4" label="기간으로 설정" defaultChecked />
                      <Radio name="t4" label="발급일 기준으로 설정" />
                    </div>
                    <FormDateRange time className="mt-[0.8125rem]" />
                    <p className="text-muted text-sm mt-3">
                      유효기간 시작일시는 발급기간 시작일시와 동일하게
                      자동입력됩니다.
                    </p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan={5}>
                    <div className="flex items-center gap-7">
                      <Radio name="t5" label="다운로드" defaultChecked />
                      <Radio name="t5" label="직접등록" />
                    </div>
                    <p className="text-muted text-sm mt-3">
                      다운로드: 고객이 다운로드 버튼을 클릭하여 쿠폰을 발급해야
                      사용가능합니다.
                      <br />
                      직접등록: 쿠폰QR 또는 쿠폰코드를 직접 등록하여
                      사용가능합니다.
                    </p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan={5}>
                    <div className="flex items-center gap-3">
                      <Radio name="t6" label="제한없음" defaultChecked />
                      <div className="flex items-center gap-3">
                        <Radio name="t6" label="제한있음" />
                        <Input size="m" disabled />
                        <span>매</span>
                      </div>
                    </div>
                    <p className="text-muted text-sm mt-3">
                      발급쿠폰수량을 제한하지 않는 것을 말합니다.
                      <br />
                      쿠폰 상태값이 진행중일 경우 계속 다운받을 수 있지만
                      회원ID당 같은 쿠폰은 한번만 다운받을 수 있습니다.
                    </p>
                  </td>
                </tr>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td colSpan={5}>
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-3">
                        <Radio name="t7" label="회원" defaultChecked />
                        <SelectBasic defaultSelect size="m" />
                ...
                <tr>
                  <td colSpan={5}>
                    <div className="flex justify-center items-center gap-2 h-[7.375rem]">
                      <Button type="outline" size="s" className="opacity-60">
                        조회
                      </Button>
                      <span className="text-muted text-sm">
                        버튼을 선택한 후 대상을 선택해주세요.
                      </span>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan={5}>
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-3">
                        <Radio name="t8" label="회원" defaultChecked />
                        <SelectBasic defaultSelect size="m" />
                        <Button type="outline" size="s">
                          조회
                        </Button>
                ...
                <tr>
                  <td colSpan={5}>
                    <div className="flex items-center min-h-[2.5rem]">
                      <p className="h4">
                        총 <span className="text-green">99</span>건
                      </p>
                ...
                <tr>
                  ...
                  <td>
                    <div className="flex items-center gap-7">
                      <Radio name="t9" label="제외없음" defaultChecked />
