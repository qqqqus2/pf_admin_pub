        ...
        <div>
          ...
          <div className="table-basic mt-2">
            <table>
              ...
              <tbody>
                <tr>
                  <th className="bg-h-green">연관문의 링크</th>
                  <td>
                    <div className="flex flex-wrap items-center gap-2">
                      <SelectBasic size="m" placeholder="사용자관리" />
                      ...
                      <button type="button">
                        <span className="underline">Q87654321</span>
                      </button>
                    </div>
                  </td>
                </tr>
          ...
          <div className="table-memo bg-cell-purple">
            <table>
              <tbody>
                <tr>
                  <td>
                    <p className="no-data py-5">관리자 메모 이력이 없습니다.</p>
                  </td>
                </tr>
              </tbody>
            </table>
