...
export default function BO082001a() {
  return (
    <DefaultLayout>
      <Topbar
        title="메뉴권한관리"
      ...
      <div className="box-cont grow-0">
        <ul className="list-dot text-[#6A798F] text-base font-medium -my-[0.625rem]">
          <li>
            슈퍼관리자만이 새로운 관리자를 등록하고, 관리자별 권한 메뉴를 설정할
            수 있습니다.
          </li>
          <li>
            관리자명을 클릭하여 관리자 권한 메뉴를 오른쪽 영역에서 권한 설정을
            통해 할 수 있으며, 관리자 목록 내 편집으로 프로필 수정이 가능합니다.
          </li>
          <li>
            상위 메뉴 선택 시 하위 메뉴가 모두 선택되며 하위 메뉴에서 선택 또는
            해제할 수 있습니다.
          </li>
        </ul>
      </div>
      <div className="grow grid grid-cols-2 gap-[1.875rem] mt-[1.875rem]">
                    ...
                    <td>
                      <div>
                        <div className="flex items-center gap-2">
                          <Radio name="t1" label="파트너" size="s" />
                          <Radio
                            name="t1"
                            label="파트너"
                            size="s"
                        ...
                        <div className="flex items-center gap-2 mt-3">
                          <Input defaultValue="김관리" className="w-[7rem]" />
        ...
        <div className="box-cont">
          <div className="grow flex flex-col">
            ...
            <div className="grow flex justify-center items-center mt-4">
              <div className="flex items-center gap-[1.25rem]">
                <Button type="outline" size="s">
                  설정
                  <IcArrowRight />
                </Button>
                <span className="text-[#6A798F] text-base font-medium">
                  버튼을 선택하시면 메뉴별 권한을 설정 할 수 있습니다.
                </span>
              </div>
            </div>
          </div>
