    ...
    <DefaultLayout>
      <div className="relative grow py-[2.5rem]">
        ...
        <dl className="flex flex-col gap-8 max-w-[70rem] mt-9">
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">관리자명&#40;아이디&#41; / 소속</th>
                      <td>
                        관리자가 작성한 메모가 표기됩니다. 관리자가 작성한
                        메모가 표기됩니다. 관리자가 작성한 메모가
                        표기됩니다.관리자가 작성한 메모가 표기됩니다. 관리자가
                        작성한 메모가 표기됩니다. 관리자가 작성한 메모가
          ...
          <div className="flex flex-col gap-6 pb-8 border-b border-b-green">
            <dt className="h4">Table Basic - Bordered / Align / Bg</dt>
            <dd>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td className="bg-h-green">bg-h-green</td>
                      <td className="bg-h-red">bg-h-red</td>
                      <td className="bg-h-green"></td>
                      <td className="bg-h-green"></td>
                      <td className="bg-h-green"></td>
                      <td className="bg-h-green"></td>
          ...
          <div className="flex flex-col gap-6 pb-8 border-b border-b-green">
            <dt className="h4">
              Table Grid with VScroll&#40;높이 지정&#41; - Row 10 / 20 / 30 / 40
              / 50
            </dt>
            <dd>
              <div className="table-grid row-10">
                <table>
                  <colgroup>
                    ...
                    <col />
                    <col width="15%" className="bg-cell-blue" />
                    <col />
                    <col />
                    <col />
                    <col />
                  ...
                  <thead>
                    <tr>
                      ...
                      <th scope="col">상세내용</th>
                      <th scope="col" className="bg-h-blue">
                        일시
                      </th>
                      <th scope="col">적립</th>
                      <th scope="col">사용</th>
          ...
          <div className="flex flex-col gap-6 pb-8 border-b border-b-green">
            <dt className="h4">Table Grid with VScroll & HScroll</dt>
            <dd>
