                ...
                <tr>
                  ...
                  <td colSpan={3}>
                    <div className="flex items-center gap-3">
                      ...
                      <Radio name="t31003" label="미설정" defaultChecked />
                    </div>
                  </td>
                </tr>
                <tr>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    하이파킹 관리자 이며 , 해당 담당자 요청으로 IP 미설정
                    2024-01-01 00:00
                  </td>
                </tr>
              </tbody>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td colSpan={3}>
                    <div className="flex items-center gap-3">
                      <Radio name="t1" label="Android" defaultChecked />
                  ...
                  <td colSpan={3}>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-muted">
                        실제 스토어에 업데이트되는 버전과 동일하게 입력해주세요.
                      </span>
                    </div>
                  </td>
                </tr>
                <tr>
                  <th scope="row">
                    <span className="text-req">사용여부</span>
                  </th>
                  <td colSpan={3}>
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-3">
                        <Radio name="t3" label="사용" defaultChecked />
                ...
                <tr>
                  <th scope="row">
                    <span className="text-req">업데이트내용</span>
                  </th>
                  <td colSpan={3}>
                    <FormEditor />
                  </td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td colSpan={3}>
                    <div className="flex items-center gap-3">
                      <Radio name="t88002a" label="활성" defaultChecked />
                      <Radio name="t88002a" label="정지" />
                    </div>
                  </td>
                </tr>
                <tr>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div className="flex items-center gap-3">
                        <Radio name="t88003" label="전체" defaultChecked />
                        <Radio name="t88003" label="사용(Y)" />
                        <Radio name="t88003" label="사용안함(N)" />
                      </div>
                    </td>
