        ...
        <dl className="flex flex-col gap-8 max-w-[70rem] mt-9">
          <div className="flex flex-col gap-6 pb-8 border-b border-b-green">
            ...
            <dd className="grid grid-cols-4 gap-4">
              ...
              <Checkbox label="Check_On_Dis" defaultChecked disabled />
              <Checkbox label="Check_Off_Dis" disabled />
              <Radio name="t3" label="Radio_On_Dis" defaultChecked disabled />
          ...
          <div className="flex flex-col gap-6 pb-8 border-b border-b-green">
            ...
            <dd className="grid grid-cols-4 gap-4">
              <Checkbox label="Check_On_small" size="s" defaultChecked />
              <Checkbox label="Check_Off_small" size="s" />
              <Radio name="t2" label="Radio_On_small" size="s" defaultChecked />
              ...
              <Checkbox
                ...
                disabled
              />
              <Checkbox label="Check_Off_Dis_small" size="s" disabled />
              <Radio
                name="t4"
                ...
                disabled
              />
              <Radio name="t4" label="Radio_Off_Dis_small" size="s" disabled />
              <Checkbox size="s" defaultChecked />
              <Checkbox size="s" />
              <Radio name="t6" size="s" defaultChecked />
              <Radio name="t6" size="s" />
              <Checkbox size="s" defaultChecked disabled />
            ...
            <dd className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Input placeholder="판매중지사유를 입력하세요." disabled />
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Radio name="t10" label="제한없음" defaultChecked />
                <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-3">
                  <Radio name="t11" label="회원" defaultChecked />
              ...
              <div className="flex items-center gap-3">
                <Radio name="t12" label="당일예약" defaultChecked />
                <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <Radio name="t13" label="설정안함" defaultChecked />
                <div className="grow flex items-center gap-3">
                  <Radio name="t13" label="예약결제" />
                  <Input placeholder="HTTP://" disabled className="grow" />
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Radio name="t14" label="허용안함" defaultChecked />
                <div className="grow flex items-center gap-3">
