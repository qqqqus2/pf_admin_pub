          ...
          <ul>
            <li>
              <p className="inline-flex items-center gap-2">
                신청유형
                <span data-tooltip-id="tooltip" data-tooltip-html="신청유형">
                  <IcInfo />
                </span>
              </p>
            ...
            <li>
              <p className="inline-flex items-center gap-2">
                검토결과
                <span data-tooltip-id="tooltip" data-tooltip-html="검토결과">
                  <IcInfo />
                </span>
              </p>
              <div className="flex items-center gap-3">
            ...
            <li>
              <p className="inline-flex items-center gap-2">
                신청지역
                <span data-tooltip-id="tooltip" data-tooltip-html="신청지역">
                  <IcInfo />
                </span>
              </p>
            ...
            <li>
              <p className="inline-flex items-center gap-2">
                요금방식
                <span data-tooltip-id="tooltip" data-tooltip-html="요금방식">
                  <IcInfo />
                </span>
              </p>
              <div className="flex items-center gap-3">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button type="button">
                      <span className="underline">Q12345672</span>
                    </button>
                  </td>
                  <td>개인주차공간</td>
                  <td>경기도</td>
